...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    ...
    // Polling a cada 10 segundos para tempo real (reduzido para evitar sobrecarga)
    ...
    <div className="relative min-h-screen overflow-hidden bg-[#0a0118]">
      ...
      <div className="relative z-10">
        ...
        <footer className="relative py-16 px-6 overflow-hidden">
          {/* Background effects */}
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute bottom-0 left-1/4 w-[600px] h-[300px] bg-purple-600/10 rounded-full blur-[120px]" />
            <div className="absolute bottom-0 right-1/4 w-[600px] h-[300px] bg-cyan-600/10 rounded-full blur-[120px]" />
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-12 mb-12">
              ...
              <div className="md:col-span-1">
                <div className="flex items-center gap-4 mb-4">
                  <div className="relative group">
                    <div className="absolute -inset-2 bg-gradient-to-r from-purple-500/50 to-cyan-500/50 rounded-2xl blur-lg opacity-50 group-hover:opacity-75 transition-opacity" />
                    <Image
                      src="/images/gv-logo-new.jpeg"
                      alt="GV Software"
                      width={56}
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-white">GV Software</h3>
                    <p className="text-sm text-purple-400">Inovacao & Tecnologia</p>
                  </div>
                </div>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Transformando ideias em solucoes digitais de alta performance. Desenvolvimento web e mobile sob medida para seu negocio.
                </p>
              </div>
              ...
              <div className="md:col-span-1">
                ...
                <ul className="space-y-3">
                  <li>
                    <a href="#sobre" className="text-gray-400 hover:text-purple-400 transition-colors text-sm flex items-center gap-2 group">
                      <ArrowRight className="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                      Sobre Nos
                    </a>
                  </li>
                  <li>
                    <a href="#habilidades" className="text-gray-400 hover:text-purple-400 transition-colors text-sm flex items-center gap-2 group">
                      <ArrowRight className="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                      Habilidades
                    </a>
                  </li>
                  <li>
                    <a href="#projetos" className="text-gray-400 hover:text-purple-400 transition-colors text-sm flex items-center gap-2 group">
                      <ArrowRight className="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                      Projetos
                    </a>
                  </li>
                  <li>
                    <a href="#contato" className="text-gray-400 hover:text-purple-400 transition-colors text-sm flex items-center gap-2 group">
                      <ArrowRight className="w-3 h-3 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all" />
                      Contato
                    </a>
                  </li>
              ...
              <div className="md:col-span-1">
                ...
                <div className="space-y-3 mb-6">
                  <a href="mailto:contato.gvsoftware@gmail.com" className="text-gray-400 hover:text-purple-400 transition-colors text-sm flex items-center gap-2">
                    <Mail className="w-4 h-4" />
                    contato.gvsoftware@gmail.com
                  </a>
                  <a href="https://wa.me/5517997853416" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-green-400 transition-colors text-sm flex items-center gap-2">
                ...
                <div className="flex items-center gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative w-11 h-11 rounded-xl bg-gradient-to-br from-pink-500/20 to-purple-500/20 border border-pink-500/30 flex items-center justify-center hover:scale-110 hover:shadow-lg hover:shadow-pink-500/20 transition-all duration-300"
                  >
                    <Instagram className="w-5 h-5 text-pink-400" />
                  </a>
                  <a
                    href="https://www.facebook.com/gvsoftware"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative w-11 h-11 rounded-xl bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/30 flex items-center justify-center hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative w-11 h-11 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 border border-green-500/30 flex items-center justify-center hover:scale-110 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300"
                  >
